...
CMDS1="cargo run --release --bin univar_opt_bench_multhr -- --repeat=1 --min-size=16 --max-size=16 --prepare-threads=64 --run-threads=1 --batch-opening-threads=8 | tee -a output_log/univar_opt_bench_run_1_open_8.log "
...
# CMDS1="cargo run --release --bin mullin_opt_bench_multhr -- --repeat=1 --min-size=10 --max-size=10 --prepare-threads=64 --run-threads=1 --poly-commit-scheme=hyrax --batch-opening-threads=4 | tee -a output_log/mullin_opt_bench_1_26_28_run_1_open_4.log "
